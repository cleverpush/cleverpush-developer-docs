...
const siteConfig = {
  ...
  projectName: 'cleverpush-developer-docs',
  organizationName: 'cleverpush',
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} CleverPush`,
  ...
  stylesheets: ['https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.12.0-2/css/all.min.css'],
